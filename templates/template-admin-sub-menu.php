...
<div class="tab-container">
    ...
    <div class="tabs-container common-shadow">
        ...
        <div class="tabs">
            ...
            <button class="tab" data-tab="cron-jobs-control">Cron Jobs</button>
    ...
    <div class="tabs-contents-container">
        ...
        <div class="tab-content" id="cron-jobs-control" style="display: none;">
            <?php include_once PLUGIN_BASE_PATH . '/templates/template-parts/template-part-cron-jobs-control.php'; ?>
        </div>
